...
export async function GET(req: NextRequest, { params }: { params: { postSlug: string } }) {
  try {
    const keys = await kv.keys(`comment:${params.postSlug}:*`)
...
export async function POST(req: NextRequest, { params }: { params: { postSlug: string } }) {
  try {
    ...
    await kv.set(`comment:${params.postSlug}:${id}`, comment)
          ...
          html: `
            <div style="font-family:sans-serif;max-width:600px;margin:0 auto;">
              ...
              <table style="width:100%;border-collapse:collapse;margin-bottom:16px;">
                ...
                <tr><td style="padding:8px;font-weight:bold;color:#555;">Bài viết:</td><td style="padding:8px;">${params.postSlug}</td></tr>
              </table>
