...
const translations = {
  en: {
    // Header Navigation
    'header.home': 'Home',
    'header.about': 'Who I Am',
    'header.projects': 'What I Seek',
    'header.blog': 'My Thoughts',
    'header.contact': 'Talk to Me',
    'header.admin': 'Admin',
    ...
    // Home Page
    'home.hero.name': 'Minh Tran',
    'home.hero.tagline': 'Head of Digital & Technology | Supply Chain',
    'home.hero.description': 'Welcome to my little garden. 20 years building digital capability across Unilever Greater Asia. Now stepping into a new chapter — finding what to build next.',
    ...
    'home.origin.act1': 'LinkedIn is the gate. This is the garden — a quieter space to think, write, and explore what comes next after 20 years in corporate life.',
    ...
    'projects.subtitle': 'Initiatives and ideas I am exploring',
    'projects.empty': 'Projects coming soon...',
    'projects.emptySubtitle': 'Check back soon',
    ...
    // Blog Page
    'blog.title': 'Blog',
    'blog.subtitle': 'A journey in four chapters — building in public, one essay at a time',
    'blog.empty': 'First essays coming soon...',
    'blog.emptySubtitle': 'Published every two weeks',
  ...
  vi: {
    ...
    'header.about': 'Tôi là ai',
    'header.projects': 'Tôi đang tìm gì',
    'header.blog': 'Tôi nghĩ gì',
    'header.contact': 'Nói chuyện với tôi',
    ...
    'home.origin.act1': 'LinkedIn là cái cổng. Đây là khu vườn — không gian tĩnh lặng hơn để suy nghĩ, viết và khám phá điều gì đến tiếp theo sau 20 năm trong môi trường doanh nghiệp.',
    'home.origin.act2.intro': 'Câu hỏi tôi luôn quay lại:',
    'home.origin.act2.question': 'Xây dựng điều gì đó thực sự có ý nghĩa — điều đó trông như thế nào?',
    ...
    'projects.subtitle': 'Những sáng kiến và ý tưởng tôi đang khám phá',
    'projects.empty': 'Dự án sắp ra mắt...',
    'projects.emptySubtitle': 'Quay lại sớm nhé',
    ...
    // Blog Page
    'blog.title': 'Blog',
    'blog.subtitle': 'Hành trình qua bốn chương — xây dựng công khai, mỗi hai tuần một bài',
    'blog.empty': 'Những bài viết đầu tiên sắp ra mắt...',
    'blog.emptySubtitle': 'Xuất bản mỗi hai tuần',
